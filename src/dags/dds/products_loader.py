...
from dds.restaurant_loader import (RestaurantDdsRepository, RestaurantStgObj,
                                   RestaurantDdsObj)
...
class ProductLoader:
    ...
    def __init__(self, pg: PgConnect, settings_repository: DdsEtlSettingsRepository) -> None:
        self.dwh = pg
        self.raw = RestaurantDdsObj()
        self.dds_products = ProductDdsRepository()
        self.dds_restaurants = RestaurantDdsRepository()
        self.settings_repository = settings_repository

    def parse_restaurants_menu(self, restaurant_raw: RestaurantStgObj, restaurant_version_id: int) -> List[ProductDdsObj]:
        res = []
